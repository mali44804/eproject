        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light p-0">
            ...
            <div class="collapse navbar-collapse " id="navbarCollapse">
                ...
                <div class="navbar-nav mx-auto  py-0">
                    ...
                    <a href="service.php" class="nav-item nav-link" style="font-size: 20px;">Service</a>
                    <a href="team.php" class="nav-item nav-link" style="font-size: 20px;">Attorneys</a>
                    <a href="blog.php" class="nav-item nav-link" style="font-size: 20px;">Blogs</a>
                ...
                <a href="login.php" class="btn btn-primary mr-3 d-none d-lg-block" style="font-size: 18px;">Login </a> 
                    ...
                    <div class="dropdown nav-item nav-link">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" href="attorneyregister.php">Attorney</a>
                            <a class="dropdown-item" href="clientregister.php">Client</a>
                        </div>
                    </div>
                    <div class="dropdown nav-item nav-link">
                        <button class="btn btn-secondary dropdown-toggle ml-auto" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" href="attorneylogin.php">Attorney</a>
                            <a class="dropdown-item" href="clientlogin.php">Client</a>
                        </div>
                    </div>
