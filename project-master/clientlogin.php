...
<section class=" text-center text-lg-start">
    ...
    if(isset($_POST['submit'])){
      ...
      $email_search = "SELECT * from `client-registration` where email = '$email'";
      ...
      <div class="row g-0 d-flex align-items-center">
        ...
        <div class="col-lg-8">
          <div class="card-body py-5 px-md-5">
            <h1 style="text-align: center;font-family: sans-serif;">Client Login</h1>
            <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST">
              ...
              <a href="clientregister.php"><h5 style="text-align: center;">Don't have account</h5></a>
            </form>
